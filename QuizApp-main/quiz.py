...
def loginPage(logdata):
    ...
    login_canvas = Canvas(login,width=720,height=440,bg="green")
    login_canvas.pack()

    login_frame = Frame(login_canvas,bg="white")
    login_frame.place(relwidth=0.8,relheight=0.8,relx=0.1,rely=0.1)

    heading = Label(login_frame,text="DonJava Exam Login",fg="black",bg="white")
...
def signUpPage():
    ...
    heading = Label(sup_frame,text="DonJava Exam SignUp",fg="black",bg="white")
    heading.config(font=('calibri 40'))
    heading.place(relx=0.2,rely=0.1)
...
def menu():
    ...
    wel = Label(menu_canvas,text=' W E L C O M E  T O DONJAVA EXAM  ',fg="white",bg="#101357")
    wel.config(font=('Broadway 22'))
    wel.place(relx=0.1,rely=0.02)
    
    
    level = Label(menu_frame,text='Select a Subject !!',bg="white",font="calibri 18")
...
def start():
    ...
    img = PhotoImage(file="cover1.png")
